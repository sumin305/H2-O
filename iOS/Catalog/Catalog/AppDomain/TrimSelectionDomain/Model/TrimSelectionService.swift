...
extension Quotation: TrimSelectionService {
  func saveDefaultQuotation(trim: Trim, carQuotation: CarQuotation, minPrice: CLNumber, maxPrice: CLNumber) {
    ...
    quotation = CarQuotation(trim: trim,
                             powertrain: carQuotation.powertrain,
                             bodytype: carQuotation.bodytype,
                             drivetrain: carQuotation.drivetrain,
                             externalColor: carQuotation.externalColor,
                             internalColor: carQuotation.internalColor,
                             options: carQuotation.options)
